...
void ConcurrentScaleTest() {
  ...
  size_t total_keys = 200000;// originally 200000
  size_t sieve = 10;
  ...
  //std::cout << "test for number of keys"<< std::endl;
...
TEST(HashTableScaleTest, ConcurrentScaleTest) {
  TEST_TIMEOUT_BEGIN
  ConcurrentScaleTest();
  TEST_TIMEOUT_FAIL_END(3 * 1000 * 120)// originally 3*1000*120
}
